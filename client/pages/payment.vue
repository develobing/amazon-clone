            ...
            <div class="a-section">
              ...
              <form action="#" method="post">
                <div class="a-spacing-medium a-spacing-top-medium">
                  ...
                  <div>
                    <span>If the address contains typos or other errors, your
...
export default {
  ...
  mounted() {
    /* eslint-disable */
    this.stripe = Stripe(
      "pk_test_51HYYZjGKOb07aBAdDwwWr6CIX29i89vJ12VaadEmioR96GG98N26FLrLu40xHm92C79Dyz27JPoV7T0gtrMEeMEe007xPpMnKO"
    );
