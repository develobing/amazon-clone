      ...
      <div class="row">
        ...
        <div class="col-xl-8 col-lg-9 col-md-12">
          ...
          <div class="orderContent">
              ...
              <div class="row">
                ...
                >
                  <div class="a-row">
                    ...
                    <br>
                    <span
                      class="a-size-base a-text-bold a-color-secondary"
                    >May 16, 2016</span>
                  </div>
                </div>
            ...
            <!-- Orders body -->
            <div v-for="(order, index) in orders" :key="`order_${index}`" class="orderContentBodyAlt">
              <div class="a-row">
                <h1
              ...
              <div v-for="(product, productIndex) in order.products" :key="`product_${productIndex}`">
