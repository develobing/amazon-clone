    ...
    <div class="container-fluid">
      <div class="dp-container">
        <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3">
                      <div class="smallAuthorImageContainer">
                        <a href="#">
                          <img :src="product.owner.photo" class="img-fluid" alt="">
                        </a>
                      </div>
                    </div>
                        ...
                        <a href="#">
                          <span class="btnFollow">
                            <span class="a-btn-inner">
                              <div class="a-btn-text">+ Follow</div>
                            </span>
                          </span>
                        </a>
                      </div>
          ...
          <!-- Middle 6 Grid - Description For Product -->
                    ...
                    <li class="swatchElement" style="width: 117px;">
                      <span class="a-list-item">
                        <span class="a-button-toggle">
                          <span class="a-button-inner">
                            <a href="#" class="a-button-text">
                              <span><img src="/img/audiblelogo.png" class="img-fluid" alt="" style="width: 20px;">Audible</span>
                              <br>
                              <span class="a-color-secondary">-</span>
                            </a>
                          </span>
                ...
                <div class="row">
                  <div class="col-sm-4 mb-1">
                    <div class="a-declarative">
                      Length: <span><a href="#" class="">386 pages <i class="a-icon a-icon-popover" /></a></span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="col-lg-3 col-md-3 col-sm-4">
            ...
            <div class="kcpAppBaseBox text-center">
              <img src="/img/readyondevice.png" class="img-fluid" alt="">
            </div>
          </div>
        </div>
        ...
        <div class="books-entity-teaser">
          <div class="bucket">
            ...
            <div class="content">
              <div class="row">
                <!-- Author's photo and Follow Button -->
