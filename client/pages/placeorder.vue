    ...
    <div class="container-fluid">
      <div class="shipping-address">
        ...
        <div class="a-row">
          ...
          <div class="a-row a-spacing-small a-size-mini" />
        </div>
        <div class="row">
            ...
            <div class="spc-orders a-box">
              <div class="a-box-inner">
                <div class="shipping-group">
                  ...
                  <div class="row">
                    <!-- Cart -->
                    <div v-for="(product, index) in getCart" :key="`cart_${index}`" class="col-xl-6 col-lg-7 col-sm-6 col-12">
                      <div class="a-row a-spacing-base">
                        <div class="row">
                          <!-- Product's photo -->
                            ...
                            <div class="a-row">
                              <div class="a-row a-spacing-top-micro">
                                <span class="a-button-small">
                                  <span class="a-button-inner">
                                    <i class="a-icon checkout-giftbox-icon" />
                                    <a
                                      href="#"
                      ...
                      <div class="a-row shipping-speeds">
                        <fieldset>
                          ...
                          <div class="a-spacing-mini wednesday">
                            <!-- Shipping normal -->
                            <input type="radio" name="order0" checked="true" @change="onChooseShipping('normal')">
              ...
              <div class="a-box a-first">
                <div class="a-box-inner">
                  ...
                  <div class="a-row">
                    ...
                    <h3 class="a-spacing-micro a-size-base">
                      Order Summary
                    </h3>
...
export default {
  ...
  async asyncData({ $axios, store }) {
    try {
      const response = await $axios.$post('/api/shipment', { shipment: 'normal' });
  ...
  methods: {
    async onChooseShipping(shipment) {
      try {
        const response = await this.$axios.$post('/api/shipment', { shipment });
