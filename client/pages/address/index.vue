            ...
            <div class="a-section a-spacing-medium">
              ...
              <div class="a-spacing-double-large">
                <div class="row a-spacing-micro">
                  ...
                  <!-- Address -->
                  <div v-for="(address, index) in addresses" :key="`address_${index}`" class="col-lg-4 col-md-4 col-sm-12 pl-md-0 pb-2">
...
export default {
  ...
  methods: {
    ...
    async onSetDefault(id) {
      try {
        const response = await this.$axios.$put('/api/addresses/set/default', { id });
