        ...
        <div class="col-lg-6 col-md-7 col-sm-12">
          <div class="reviews-image-gallery">
            ...
            <div class="a-spacing-small a-spacing-top-small">
              <img v-for="(review, index) in reviews" :key="`cutomer_${index}`" :src="review.photo" class="img-fluid" width="22.5%">
            </div>
            <div>
          ...
          <div class="cr-widget-focalreviews">
            <div class="card-padding">
              ...
              <!-- Reviews -->
              <div v-for="(review, index) in reviews" :key="`review_${index}`" class="review-body">
