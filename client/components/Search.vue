<template>
  <div>
    <svg xmlns="http://www.w3.org/2000/svg" style="display:none">
      <symbol id="sbx-icon-search-11" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40">
        <path
      ...
      <symbol id="sbx-icon-clear-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
