<template>
  <main>
    ...
    <div class="a-spacing-large" />
    <div class="container-fluid browing-history">
      <div class="row">
        <div
        ...
        >
          <div class="history-box">
            ...
            <div class="a-row">
              ...
              <span
                class="a-color-teritary a-size-small asin-reviews"
              >(1732)</span>
            </div>
            ...
            <div class="a-row">
              ...
              <span class="a-button-history margin-right-10" @click="onDeleteProduct(product._id, index)">
                Delete
              </span>
            </div>
          </div>
...
export default {
  ...
  // It is goot for SEO because the data will be loaded first
